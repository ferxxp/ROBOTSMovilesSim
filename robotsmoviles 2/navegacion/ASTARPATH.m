function OptimalPath=ASTARPATH(Start,GRID,Goal,Connecting_Distance,inflation)
...
Goal=Goal';
MAPB=binaryOccupancyMap(getOccupancy(GRID),GRID.Resolution);
MAP = getOccupancy(MAPB); 
...
this uses alot of CPU time. If you have any more efficient way to add this effect in the code, please contact me and 
